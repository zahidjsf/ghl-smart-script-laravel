    ...
    <div class="col-md-12">
        <div class="card card-round">
            <div class="card-header">
                <h4 class="card-title">Create Snapshot</h4>
            </div>
            <div class="card-body">
                ...
                <form action="{{ route('admin.snapshotstore') }}" method="post" enctype="multipart/form-data">
                    @csrf

                    <div class="form-group">
                        <label for="name">Name</label>
                        <input type="text" class="form-control" id="name" name="name" placeholder="Snapshot Name" required value="{{ old('name') }}">
                    </div>

                    <div class="form-group">
                        <label for="url">URL</label>
                        <input type="text" class="form-control" id="url" name="url" placeholder="URL" required value="{{ old('url') }}">
                    </div>
                    ...
                    <div class="form-group">
                        <label for="server_image">Select Image</label>
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="server_image" name="server_image" accept="image/*">
                            {{-- <label class="custom-file-label" for="server_image">Choose file</label> --}}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="documentation" id="documentation" rows="3">{{ old('documentation') }}</textarea>
                    </div>
